...
public class DataManager {
    ...
    private final LoadingCache<UUID, UserData> userDataCache = CacheBuilder
            .newBuilder()
            .concurrencyLevel(4)
            .build(new CacheLoader<UUID, UserData>() {
                ...
                public UserData load(UUID uniqueId) throws Exception {
                    ...
                    try (PreparedStatement selectStatement = Main.getDatabaseManager().getConnection().prepareStatement("SELECT `last_name`, `last_ip`, `online_time`, `first_login`, `last_login`, `real_name`, `discord_name`, `teamspeak_name`, `skype_name` FROM `hc_user_data` WHERE `uniqueId` = ?")) {
                        ...
                        try (ResultSet resultSet = selectStatement.executeQuery()) {
                            ...
                            try (PreparedStatement insertStatement = Main.getDatabaseManager().getConnection().prepareStatement("INSERT IGNORE INTO `hc_user_data` (`uniqueId`, `last_name`, `last_ip`, `online_time`, `first_login`, `last_login`, `real_name`, `discord_name`, `teamspeak_name`, `skype_name`) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")) {
    ...
    public void update(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_currency` SET `last_name` = ?, `last_ip` = ?, `online_time` = ?, `first_login` = ?, `last_login` = ?, `real_name` = ?, `discord_name` = ?, `teamspeak_name` = ?, `skype_name` = ? WHERE `uniqueId` = ?")) {
    ...
    public void updateLastname(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `last_name` = ? WHERE `uniqueId` = ?")) {
                updateStatement.setString(1, data.getLastName());
    ...
    public void updateLastIP(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `last_ip` = ? WHERE `uniqueId` = ?")) {
    ...
    public void updateRealName(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `real_name` = ? WHERE `uniqueId` = ?")) {
    ...
    public void updateDiscordName(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `discord_name` = ? WHERE `uniqueId` = ?")) {
    ...
    public void updateTeamspeakName(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `teamspeak_name` = ? WHERE `uniqueId` = ?")) {
    ...
    public void updateSkypeName(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `skype_name` = ? WHERE `uniqueId` = ?")) {
    ...
    public void updateOnlineTime(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `online_time` = ? WHERE `uniqueId` = ?")) {
    ...
    public void updateFirstLogin(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `first_login` = ? WHERE `uniqueId` = ?")) {
    ...
    public void updateLastLogin(UserData data) {
        Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
            try (PreparedStatement updateStatement = Main.getDatabaseManager().getConnection().prepareStatement("UPDATE `hc_user_data` SET `last_login` = ? WHERE `uniqueId` = ?")) {
